//here we are importing the actions type to handle the next different actions
import { ADD_TASK, EDIT_TASK, TOGGLE_TASK, FILTER_TASKS, DELETE_TASK } from '../actions/actionTypes';

//here we're defining the initial state object for the task reducer
const initialState = {
...
//we add default to handle all actions that are not made by the reducer and it returns the same current state
    default:
      return state;
  }
};
